...
MANAGEMENT_IP=$(whiptail --nocancel --inputbox "Please enter the management IP" 20 60 "192.168.123.XXX" 3>&1 1>&2 2>&3)
if [ $? -eq 0 ]; then
  sed -i "s/#MANAGEMENT_INTERFACE/iface eth0:1 inet static/g" /etc/network/interfaces
